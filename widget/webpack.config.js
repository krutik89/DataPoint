...
const COMPONENTS = {
  DataPoint: './src/components/DataPoint/index.ts',
  DataPointConfiguration: './src/components/DataPointConfiguration/index.ts',
};
  ...
  return {
    ...
    ...(!isProd && {
      devServer: {
        ...
        allowedHosts: ['app-d8d4d5aa.iocompute.ai', 'datapoint.iocompute.ai'],
